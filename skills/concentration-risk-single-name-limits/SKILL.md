...
description: >-
  Quantitative pre-trade risk engine for enforcing single-name NAV exposure caps, liquidity ADV constraints, order downsizing, and calculating portfolio Herfindahl-Hirschman Index (HHI).
