...
- [ ] Is Year-over-Year (YoY) revenue growth calculated on seasonality-aligned quarters (t vs t-4) under the company's fiscal calendar (NRF 4-5-4 for US retailers, with 53-week restatements)?
...
- [ ] Is vendor due diligence documented (aggregation/de-identification representations) with MNPI procedures per Advisers Act Rule 204A (or local analogue)?
