...
description: Fire drill breach simulations in paper trading.
...
Use this skill when implementing Fire drill breach simulations in paper trading.
...
1. Initialize `FireDrillSimulator`.
