...
class IcebergOrderSimulationAndDetectionConfig:
    enabled: bool = True
    threshold: float = 0.5
    size: int = 100

class IcebergOrderSimulationAndDetectionEngine:
    def __init__(self, config: IcebergOrderSimulationAndDetectionConfig):
        self.config = config
