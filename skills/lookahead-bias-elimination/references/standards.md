...
Earlier revisions of this file asserted that this skill "intersects with institutional backtesting
validation standards, GIPS, and SEBI / SEC backtesting disclosure rules." That framing was
unsourced and wrong about SEBI, whose algo-trading circular restricts performance claims rather
than requiring backtest disclosure. It has been replaced with the provision-level statements above.
