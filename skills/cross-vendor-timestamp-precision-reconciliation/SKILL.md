...
description: >-
  Quantitative market data reconciliation engine for normalizing multi-vendor timestamps (s, ms, us, ns, ISO-8601) to 64-bit nanosecond UTC epoch, detecting clock drift, and aligning tick sequences.
